...
const (
	StreamingService_DownloadFile_FullMethodName = "/streaming.StreamingService/DownloadFile"
	StreamingService_UploadFile_FullMethodName   = "/streaming.StreamingService/UploadFile"
